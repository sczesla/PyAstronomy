...
class ExoplanetsOrg(pp.PyAUpdateCycle):
  ...
  def __init__(self, skipUpdate=False):
    ...
    self._ident = {"STAR": "pl_hostname", "NAME": "pl_name",
                   "PER": "pl_orbper", "MASS": "pl_massj",
                   "MSINI": "pl_msini", "R": "pl_radj",
                   "DEPTH": "pl_trandep", "B":  "pl_impact",
                   "T14": "pl_trandur", "TT": "pl_tranmid", "T0": "pl_tperi",
                   "A": "pl_orbsmax", "AR": "pl_orbsmaxr",
                   "I": "pl_orbincl", "LAMBDA": "pl_missal", "OM": "pl_omega",
                   "ECC": "pl_ecc", "GRAVITY": "pl_grav", "DENSITY": "pl_dens",
                   "PLANETDISCMETH": "pl_dtype", "BINARY": "st_binary",
                   "RSTAR": "st_rad", "DIST": "st_dist", "PAR": "st_par",
                   "MSTAR": "st_mass", "TEFF": "st_teff", "LOGG": "st_logg",
                   "VSINI": "st_vsini", "SHK": "st_acts", "RHK": "st_actc",
                   "V": "st_vj", "FE": "st_fe", "GAMMA": "st_radv",
                   "RHOSTAR": "st_dens", "DEC_STRING": "dec",
                   "RA_STRING": "ra", "KOI": "KOI", "K": "K"}
  ...
  def _readData(self):
    ...
    desiredKeys = [k for k in self._ident.iterkeys()]
    ...
    for key in self.data.keys():
        self.data.rename(columns={key: self._ident[key]}, inplace=True)
